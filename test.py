...
def test_return_a_df_same_as_original_3():
    ...
    expected = pd.read_excel("testing_files/thesis_data_test.xlsx", "score")
    result = f.read_and_check("testing_files/thesis_data_test.xlsx", "score")
...
def test_return_expected_value():
    ...
    df_score = df_score.rename(columns={'index':'Group'})
    
    expected_score = 1.76
    
    result = f.calculate_group_score(df_elements, df_score, 'G1')
